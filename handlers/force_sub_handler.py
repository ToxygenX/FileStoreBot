...
async def handle_force_sub(bot: Client, cmd: Message):
    ...
    try:
        ...
        try:
            ...
            invite_link = await get_invite_link(bot, chat_id=channel_chat_id1) 
            invite_linc = await get_invite_link(bot, chat_id=channel_chat_id2)
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("🔸2 عضویت در چنل 🔹", url=invite_linc.invite_linc) 
                    ],
                    [
